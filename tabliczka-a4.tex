...
%                                       %
%  (c) Krzysztof Simiński, 2020-2021    %
%                                       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% imię nazwisko
% stanowisko
\newcommand{\osoba}[6][8.5cm]{%
\draw (85mm, #2 + 10mm) node [anchor=south west] {\sffamily\Large\vphantom{Iy} #3};
\draw (85mm, #2) node[anchor=south west] {\sffamily\bfseries\Huge\vphantom{Iy} #4 \MakeUppercase{#5}};
\draw[fill] (85mm, #2 - 0mm) rectangle +(#1, 0.5mm);
\draw (85mm, #2 - 7mm) node [anchor=south west] {\sffamily\vphantom{Iy} #6};
} 
